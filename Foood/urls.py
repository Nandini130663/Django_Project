...
path('lg/',g.LoginView.as_view(template_name="ht/login.html"),name="lgn"), 
path('lgg/',g.LogoutView.as_view(template_name="ht/logout.html"),name="lgo"),
# path('additem/<int:id>',views.additem,name='ai'),
]